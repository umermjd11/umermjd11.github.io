...
- **[Mastering REST APIs with FastAPI](https://www.coursera.org/learn/packt-mastering-rest-apis-with-fastapi-1xeea)** by Packt - Coursera - <span class="completed-cert">Completed with certificate</span> - **Oct 2025** - [![verify certificate](https://img.shields.io/badge/Verify-certificate-00A86B?style=for-the-badge&logo=read-the-docs&logoColor=white)](https://www.coursera.org/account/accomplishments/verify/DP160TPZG2BQ) [![PDF Badge](https://img.shields.io/badge/Certificate%20in-PDF-FF5722?style=for-the-badge&logo=file-pdf&logoColor=white)]({{ site.url }}/files/CourseraDP160TPZG2BQ.pdf) <br> This **intermediate-level** course is designed for those **familiar with Python** who want to master building **robust and efficient REST APIs** using the **FastAPI** web framework. The core objective is building an entire **social media API**. Key areas covered include:
    ...
    *   **Quality Assurance:** Utilizing **pytest**, a robust testing framework, to ensure the **reliability and maintainability** of application features like posts and comments.
    *   **Monitoring & Error Handling:** Setting up **comprehensive logging** using Python's logging module, configuring **multiple loggers**, implementing custom filters (like **correlation IDs** and email obfuscation), and integrating cloud logging tools such as **Logtail** and error tracking via **Sentry**.
...
- **[React Basics](https://www.coursera.org/learn/react-basics?specialization=meta-react-specialization)** - <span class="completed-cert">Completed with certificate</span> - Aug. 2025 [![verify certificate](https://img.shields.io/badge/Verify-certificate-00A86B?style=for-the-badge&logo=read-the-docs&logoColor=white)](https://www.coursera.org/account/accomplishments/certificate/E8LWTBEY8N31) [![PDF Badge](https://img.shields.io/badge/Certificate%20in-PDF-FF5722?style=for-the-badge&logo=file-pdf&logoColor=white)]({{ site.url }}/files/CourseraE8LWTBEY8N31.pdf)  
  Learn to build **scalable React projects**, create **reusable components**, use **props**, manage forms, and render dynamic UIs with **React.js**, **JSX**, **HTML**, **CSS**, and **JavaScript**.

- **[Advanced React](https://www.coursera.org/learn/advanced-react?specialization=meta-react-specialization)** - <span class="completed-cert">Completed with certificate</span> - Aug. 2025 [![verify certificate](https://img.shields.io/badge/Verify-certificate-00A86B?style=for-the-badge&logo=read-the-docs&logoColor=white)](https://www.coursera.org/account/accomplishments/certificate/GDNNIV3W0CBE) [![PDF Badge](https://img.shields.io/badge/Certificate%20in-PDF-FF5722?style=for-the-badge&logo=file-pdf&logoColor=white)]({{ site.url }}/files/CourseraGDNNIV3W0CBE.pdf)  
